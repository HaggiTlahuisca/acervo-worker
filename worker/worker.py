...
MIN_INTENTOS_PARA_NO_DISPONIBLE = int(os.getenv("MIN_INTENTOS_PARA_NO_DISPONIBLE", "20"))
...
def tomarsiguientecola(cola):
    """
    FIX: usa $or para que los pendientes sin next_run_at tambien sean elegibles.
    Los diferidos requieren next_run_at <= ahora.
    """
...
def workerloop():
    ...
    for nombre, fn in [
        ...
        ("registro en cola_tesis",          lambda: colatesis.create_index("registro")),
